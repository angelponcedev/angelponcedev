...
Building at the intersection of multi-agent AI and full-stack systems.  
Three-time national hackathon podium · Aguascalientes, México 🇲🇽
...
`LangGraph` `IBM WatsonX` `XGBoost` `GeoPandas` `Pandas`

**Backend & Infra**

<img src="https://skillicons.dev/icons?i=fastapi,nodejs,postgres,docker,linux&theme=dark" />

**Frontend**

<img src="https://skillicons.dev/icons?i=typescript,react,tailwind&theme=dark" />
...
```python
status = {
    "building":  "Cognos — AI-powered learning platform (Hythe, pre-alpha)",
    "studying":  "ICI · AI Specialization @ UAA · Class of 2027",
    "wins": [
        "TalentLand 2026 · IBM Track     · 2nd Place National  — urban planning multi-agent AI",
        "Hackathon Troyano 2026          · 1st Place Regional  · Best Use of Gemini",
        "TalentLand 2025 · Micron Track  · 1st Place National  — AI-driven RAM forecasting",
    ],
}
```
